...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //body: Container(),
      body: Padding(
        //Padding -> justa o conteúdo com um deslocamento.
        padding: EdgeInsets.all(16.0),
        child: SafeArea(
          child: SingleChildScrollView(
            //SingleChildScroolView -> uma caixa para único widget que
            //permite o scroll se o widget não ficar inteiramente visível.
            child: Column(
